...
export class AuthGuardUser implements CanActivate {
  ...
  canActivate(
    ...
    const token = localStorage.getItem('user'); // substitua com a lógica para obter o token JWT do armazenamento local ou de onde você o está obtendo em seu aplicativo
    if (token) {
